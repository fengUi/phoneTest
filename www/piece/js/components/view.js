define(['zepto', 'underscore', 'backbone', 'components/list', 'components/segment', 'components/carousel', 'components/extendable-list', 'components/session', 'components/base64Img', 'components/datepicker', 'components/fixed', '../base/components/footer-menu', '../base/date'],
    function($, _, Backbone, List, Segment, Carousel, ExtendableList, Session, Base64Img, Datepicker, Fixed, FooterMenu, DateUtil) {
        ...
        var CubeView = Backbone.View.extend({
            ...
            compile: function() {
                ...
                // 新增当前时间
                var date1 = new Date();
                var date2 = DateUtil.dateFormat(date1, "yyyy-MM-dd D hh:mm");
                $(this.el).find("#showTime").html(date2);
                // ===============
