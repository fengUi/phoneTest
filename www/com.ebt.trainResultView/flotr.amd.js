(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['com.ebt.trainResultView/bean', 'underscore'], function (bean, _) {
...
Flotr.defaultOptions = {
  colors: ['#4c79b0', '#C0D800', '#CB4B4B', '#4DA74D', '#9440ED'], //=> The default colorscheme. When there are > 5 series, additional colors are generated.
  ...
  fontSize: 8,           // => canvas' text font size
  ...
  xaxis: {
    ...
    color: "#000000",           // => color of the ticks
  ...
  yaxis: {
    ...
    autoscale: false,      // => Turns autoscaling on with true
    autoscaleMargin: 0,    // => margin in % to add if auto-setting min/max
    color: "#000000",           // => The color of the ticks
    scaling: 'linear',     // => Scaling, can be 'linear' or 'logarithmic'
    base: Math.E,
    titleAlign: 'center',
    margin: true           // => Turn off margins with false
  ...
  grid: {
    color: '#939393',      // => primary color used for outline and labels
    backgroundColor: null, // => null for transparent, else color
    backgroundImage: null, // => background image. String or object with src, left and top
    watermarkAlpha: 0.4,   // => 
    tickColor: '#939393',  // => color used for the ticks
  ...
  _setEl: function(el) {
     ...
     */
      if(window.localStorage['lang']!==""&&window.localStorage['lang']!==undefined&&window.localStorage['lang']!==null&&window.localStorage['lang']==="en-us"){
        new Piece.Toast("Request error, please try again later!");
        }else{
        new Piece.Toast("请求出错，请稍后尝试!");
        }
    // console.error(document.getElementsByClassName("requestError").style.display);
      /*document.getElementsByClassName("requestError").style='display:block';
      $(".requestError").show();*/
